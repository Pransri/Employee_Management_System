...
<body>
    ...
    <div class="container">
        <form method="post" action="update_user.php" onsubmit="return formvalidation();">
            <!--important action for editing-->


            <!-- edit user following code -->
            <?php
            
            $user_id=$_GET['id']; //remember

            $query="select * from users where user_id='$user_id'";
            $res=mysqli_query($conn,$query);
            $data=mysqli_fetch_array($res);
            ?>
            <input type="hidden" name="user_id" value="<?php echo $user_id;?>"> <!-- this is passed in update_user-->
            ...
            <div class="mb-3">
                ...
                <!--To show contents in the field when admin clicks on edit-->
                    ...
                    <div class="radio">
                        <label>
                            <input type="radio" name="role" id="role" value="admin"
                                <?php if($data['role']=="admin") {echo "checked";}?>>
                            Admin
                        </label>
                    </div>
